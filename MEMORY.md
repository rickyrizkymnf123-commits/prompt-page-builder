...
- **User Mapping**: `profiles` menyimpan `name`, `email`, `phone` asli (bebas `@user.local`).
- **Tab Persistence**: URL query string (`?tab=...`) dan `localStorage` sinkron 100% pada saat refresh.
